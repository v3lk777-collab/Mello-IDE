                    ...
                    monaco.languages.registerCompletionItemProvider('mello', {
                        provideCompletionItems: (model: editor.ITextModel, position: Position) => {
                            ...
                            const suggestions = [
                                ...
                                { label: 'wait', kind: monaco.languages.CompletionItemKind.Function, insertText: 'wait(${1:1000})', insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet, range },
                                { label: 'sleep', kind: monaco.languages.CompletionItemKind.Function, insertText: 'sleep(${1:1000})', insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet, range },
